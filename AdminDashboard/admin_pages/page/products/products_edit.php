...
<body>
    ...
    <section class="section_suasanpham">
        ...
        <div class="div_products_edit_1">

            <p class="text text-hnm">Sửa sản phẩm</p>
            <div id="div_products_edit_enter">
                <div id="div_suasanpham">
                    <label id="label_sua_tensanpham">Tên sản phẩm</label>
                    <input type="text" id="input_sua_tensanpham" name="input_sua_tensanpham" placeholder="Nhập tên sản phẩm">
                </div>
                <br>
                <div id="div_sua_giasanpham">
                    <label id="label_sua_giasanpham">Giá sản phẩm</label>
                    <input type="text" id="input_sua_giasanpham" name="input_sua_giasanpham" placeholder="Nhập giá sản phẩm">
                </div>
                <br>
                <div id="div_sua_danhmuc_dong_kieudang">
                    <div id="div_sua_danhmucsanpham">
                        <label id="label_sua_danhmucsanpham">Danh mục</label>
                    ...
                    <div id="div_sua_dongsanpham">
                        <label id="label_sua_dongsanpham">Dòng</label>
                ...
                <div id="div_sua_thongtinsanpham">
                    ...
                    <textarea id="textarea_sua_thongtinsanpham" name="textarea_sua_thongtinsanpham" rows="8"></textarea>
                </div>
                <button type="button" class="btn-suasanpham">
                    <span class="btn-suasanpham-text" name="btn-suasanpham-text"><b>Sửa sản phẩm</b></span>
                </button>

            </div>
        </div>

        <div class="div_products_edit_2">
            <label id="label_edit_mausanpham">Màu sản phẩm</label>
            <div class="color-box_sua">
                <div id="color-box_sua_mauden" name="color-box_sua_mauden" class="sua-color-option"></div>
                <div id="color-box_sua_maunau" name="color-box_sua_maunau" class="sua-color-option"></div>
                <div id="color-box_sua_mautrang" name="color-box_sua_mautrang" class="sua-color-option"></div>
            </div>
            <div id="div_sua_color_size_uploadimage">
                <div id="div_sua_table_size">
                    <table>
                        <form>
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <input class="input_sua_size" id="input_sua_size36" name="input_sua_size36" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <label id="label_sua_size39">Size 39</label>
                                        <input class="input_sua_size" id="input_sua_size39" name="input_sua_size39" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <label id="label_sua_size42">Size 42</label>
                                        <input class="input_sua_size" id="input_sua_size42" name="input_sua_size42" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <input class="input_sua_size" id="input_sua_size37" name="input_sua_size37" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <label id="label_sua_size40">Size 40</label>
                                        <input class="input_sua_size" id="input_sua_size40" name="input_sua_size40" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <label id="label_sua_size43">Size 43</label>
                                        <input class="input_sua_size" id="input_sua_size43" name="input_sua_size43" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <input class="input_sua_size" id="input_sua_size38" name="input_sua_size38" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <label id="label_sua_size41">Size 41</label>
                                        <input class="input_sua_size" id="input_sua_size41" name="input_sua_size41" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                                <td>
                                    <div>
                                        <label id="label_sua_size44">Size 44</label>
                                        <input class="input_sua_size" id="input_sua_size44" type="text" placeholder="Nhập số lượng...">
                                    </div>
                                </td>
                            </tr>
                        </form>
                ...
                <br>
                <div class="div_sua_upload">
                    <div id="div_sua_upload_anh_1">
                        <label id="label_sua_anh1"><b>Ảnh 1</b> </label><br>
                        <input type="file" id="input_sua_upload_anh_1" name="input_sua_upload_anh_1" accept=".jpg, .jpeg, .png">
                        <div id="div_sua_hienthi_anh1"></div>
                    </div>
                    <div id="div_sua_upload_anh_2">
                        <label id="label_sua_anh2"><b>Ảnh 2</b> </label><br>
                        <input type="file" id="input_sua_upload_anh_2" name="input_sua_upload_anh_2" accept=".jpg, .jpeg, .png">
                        <div id="div_sua_hienthi_anh2"></div>
                    </div>
                </div>
                <div class="div_sua_upload">
                    <div id="div_sua_upload_anh_3">
                        <label id="label_sua_anh3"><b>Ảnh 3</b> </label><br>
                        <input type="file" id="input_sua_upload_anh_3" name="input_sua_upload_anh_3" accept=".jpg, .jpeg, .png">
                        <div id="div_sua_hienthi_anh3"></div>
                    </div>
                    <div id="div_sua_upload_anh_4">
                        <label id="label_sua_anh4"><b>Ảnh 4</b> </label><br>
                        <input type="file" id="input_sua_upload_anh_4" name="input_sua_upload_anh_4" accept=".jpg, .jpeg, .png">
                        <div id="div_sua_hienthi_anh4"></div>
                    </div>
                </div>
            </div>
        </div>
